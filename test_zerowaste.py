...
def parse_args():
    ...
    parser.add_argument(
        '--show-dir', default='./visualizations', help='directory where painted images will be saved')
    parser.add_argument(
        '--gpu-collect',
        default=True,
        #action='store_true',
...
def main():
    ...
    model.PALETTE = [[10, 10, 10], [230, 5, 5],[4, 200, 3], [204, 5, 255], [5, 128, 148]] #dataset.METAINFO['palette']
    model.CLASSES = ('background','rigid_plastic', 'cardboard', 'metal', 'soft_plastic') # dataset.METAINFO['classes']
